//! Visual terminal UI render loop and user interaction handlers for the browser.
//!
//! # Purpose
//! This module coordinates input keys and mouse clicks to manage multiple browser tabs,
//! navigate web and offline file systems, download files, toggle secure private browsing sessions,
//! customize colors via presets, query historical records, and bookmark favorites.
//!
//! # Architecture
//! * [BrowserTab] encapsulates URL records, titles, and individual navigational back-histories.
//! * [BrowserApp] maintains the complete state of the interactive terminal application, coordinating tabs, filters, download streams, and panel states.
//! * [InstallerStep] models sub-navigation screens inside the Chromium installation assistant overlay.
//! * [run_browser_tui] handles standard terminal configurations (raw mode, alternative buffers) and launches the main event loop.
